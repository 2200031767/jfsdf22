              ...
              <input type="email" id="uemail" name="uemail" placeholder="Please Enter Your E-mail" required>
                ...
                <div class="input-box">
                  <span class="details"><label for="upassword">Enter Password</label> </span>
                   <input type="password" id="upassword" name="upassword" placeholder="Please Enter Your Name" required>
                    </div>
                    
                     <div class="input-box">
                       <span class="details"><label for="ucontact">Enter Contact</label></span>
                        <input type="number" id="ucontact" name="ucontact" placeholder="Please Enter Contact Number" required>
                         </div>
                    ...
                    <div class="input-box">
                        ...
                        <input type="text"  id="ulocation" name="ulocation" placeholder="Please Enter Your Name" required>
                        </div>
