   ...
   public ModelAndView userprofile()
   {
	...
	@GetMapping("addresource")
	   ...
	   private WorkoutService workService;
	    ...
	    public ModelAndView insertworkout(HttpServletRequest request,@RequestParam("workoutimage") MultipartFile file) throws Exception
	    {
	      String msg = null;
	      ...
	      try
	      {
	       ...
	       String setsandrepetitions=request.getParameter("setsandrepetitions");      
	      ...
	      w.setSetsandrepetitions(setsandrepetitions);
	      w.setDuration(duration);
	      w.setUrl(url);
	      w.setImage(blob);
	       
	       msg=workService.addWorkout(w);
	       System.out.println(msg);
